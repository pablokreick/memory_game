...
class Game(pygame.sprite.Sprite):
    ...
    def set_balls_quantity(self, value):
        self.__balls_quantity = value
    ...
    def make_pattern(self, sprites):
        self.__pattern = []
        self.__balls = []
        for _ in range(self.__balls_quantity):
    ...
    # ===== Collisions =====
    def check_collisions(self, objective, sprite_group):
        return pygame.sprite.spritecollide(
            objective, sprite_group, False, pygame.sprite.collide_mask
        )
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, groups):
        ...
        self.__lives = 3
        self.__score = 0
        self.__life_image = pygame.image.load(join("sprite", "life.png")).convert_alpha()
    ...
    life_image = property(get_life_image)
